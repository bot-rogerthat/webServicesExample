...
public interface BookingServiceImpl {
    ...
    @RequestWrapper(localName = "bookTicket", targetNamespace = "http://impl.service.booking/", className = "booking.service.impl.BookTicket")
    @ResponseWrapper(localName = "bookTicketResponse", targetNamespace = "http://impl.service.booking/", className = "booking.service.impl.BookTicketResponse")
    @Action(input = "http://impl.service.booking/BookingServiceImpl/bookTicketRequest", output = "http://impl.service.booking/BookingServiceImpl/bookTicketResponse", fault = {
     ...
     * 
     * @return
     *     returns java.util.List<booking.service.impl.Ticket>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
