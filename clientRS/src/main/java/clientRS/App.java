...
public class App {
    ...
    private static final String PURCHASE_TICKET_BY_ID = "http://localhost:8088/serviceRS-1.0-SNAPSHOT/booking/pay/";
    ...
    public static void main(String[] args) {
        ...
        System.out.println(purchaseTicket(client, 0));
    ...
    private static Ticket bookTicket(Client client, Person person, int ticketId) {
        ...
        ClientResponse response = webResource.type(MEDIA_TYPE).post(ClientResponse.class, person);
        return response.getEntity(Ticket.class);
    }

    private static Ticket purchaseTicket(Client client, int ticketId) {
